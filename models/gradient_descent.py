...
class LineSearchTool(object):
    ...
    def __init__(self, method, **kwargs):
        ...
        if self._method == 'Wolfe':
            ...
            self.c = kwargs.get('c', 1e-8)
        elif self._method == 'Formula':
            self.lam = kwargs.get('c1', 2e-8)
    ...
    def line_search(self, func, grad, x, d, previous_alpha=None):
        """
        ...
        if self._method == 'Wolfe':
            alpha = line_search(func, grad, x, d, c1=self.c1, c2=self.c2, amax=1e-3)[0]
...
class GradientDescentOptimizer:
    ...
    def optimize(self, y: List[float], trace: bool=False, lr_finder: str='Wolfe') -> tuple[List[float], Union[Dict, None], str]:
        """
